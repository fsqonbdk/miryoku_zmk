...
&kp Z,             &kp L,             &kp H,             &kp W,             &kp K,             &kp J,             &kp F,             &kp O,             &kp U,             &kp COMMAMINUS,          \
U_MT(LGUI, S),     U_MT(LALT, R),     U_MT(LCTRL, N),    U_MT(LSHFT, T),    &kp B,             &kp Y,             U_MT(LSHFT, C),    U_MT(LCTRL, E),    U_MT(LALT, I),     U_MT(LGUI, A),      \
U_LT(U_BUTTON, V), U_MT(RALT, X),     &kp M,             &kp D,             &kp Q,             &kp G,             &kp P,             &kp SQT,           U_MT(RALT, DOTPLUS),  U_LT(U_BUTTON, SLASH),\
